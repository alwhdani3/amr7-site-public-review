...
<head>
    ...
    <link rel="preload" href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;800&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
    <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;800&display=swap"></noscript>
...
<body class="font-['Tajawal'] antialiased text-slate-900 bg-slate-50 min-h-screen relative overflow-x-hidden selection:bg-[#1FA7A2] selection:text-white">
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 p-6">
        <div class="mb-8 animate__animated animate__fadeInDown">
            <a href="/" aria-label="الصفحة الرئيسية لآمر سبعة">
                <img src="{{ asset('brand/amr7/amr7-logo-lockup-light.svg') }}" class="h-20 w-auto hover:scale-105 transition-transform duration-300" alt="{{ app()->getLocale() === 'ar' ? 'شركة آمر سبعة لحلول الأعمال' : 'Amr Seven Business Solutions' }}">
            </a>
        </div>
