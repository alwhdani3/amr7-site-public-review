...
@php
    $preheader = __('email_admin_preheader', ['name' => $data['name'] ?? __('guest')]);
@endphp
        ...
        <tr>
            <td>
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" 
                    ...
                    @php
                        $fields = [
                            'email_label_client_name' => $data['name'] ?? __('not_provided'),
                            'email_label_company'     => $data['company'] ?? null,
                            'email_label_email'       => $data['email'] ?? '-',
                            'email_label_phone'       => $data['phone'] ?? '-',
                            'email_label_purpose'     => $data['subject'] ?? __('no_subject'),
                        ];
                    @endphp
